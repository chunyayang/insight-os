...
const columns = computed<TableColumn<Customer>[]>(() => [
  ...
  // LTV ranks on the raw functional amount, so a cross-market sort is currency-blind and a JPY
  // total always wins. The dual-currency cell and presentation-currency sort land in #41.
  {
