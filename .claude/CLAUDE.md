...
- **Money:** conversion is server-side (historical daily rates); the client only formats. The currency selector is Analytics-only — elsewhere show each record's functional currency.
